            ...
            child: Scaffold(
              body: Column(
                children: [
                  ...
                  selectedIndex == 0 &&
                          state is GetStudentResearchesLoadingState
                      ? Center(child: CreatLoading())
                      : selectedIndex == 0 &&
                              MainCubit.get(context)
                                  .studentResearchesStatusList
                                  .isEmpty
                          ? Text("Empty Pending Researches")
                          : Expanded(
                              child: Padding(
                              padding:
                              ...
                              child: ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    ResearchesStatus research =
                                        MainCubit.get(context)
                                            .studentResearchesStatusList[index];
                              ...
                              child: Padding(
                                ...
                                child: ListView.builder(
                                    ...
                                    itemCount: MainCubit.get(context)
                                        ...
                                        .length,
                                    itemBuilder: (context, index) {
                                      ResearchesStatus research = MainCubit.get(
                                              context)
                                          .studentResearchesStatusList[index];
                                      String? Time = research.createdAt;
                                      DateTime dateTime = DateTime.parse(Time!);
                  ...
                  // selectedIndex == 2 &&
                  //         state is GetStudentResearchesStatusLoadingState
                  //     ? Center(child: CreatLoading())
                  //     : selectedIndex == 2 &&
                  //             MainCubit.get(context)
                  //                 .studentResearchesStatusList
...
//                           "Empty Accepted Researches",
//                           style:
//                           BlackTitle.display5(context).copyWith(
//                             color: Colors.red,
//                             fontSize: 18,
//                           ),
//                         ),
